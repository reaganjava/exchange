...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>科蚁网手机网站模板</title>
		<meta name="viewport" content="width=device-width,height=device-height,inital-scale=1.0,maximum-scale=1.0,user-scalable=no;">
		<meta name="apple-mobile-web-app-capable" content="yes">
		<meta name="apple-mobile-web-app-status-bar-style" content="black">
		<meta name="format-detection" content="telephone=no">
		<meta charset="utf-8">
		<link href="${rootpath}/css/cate.css" rel="stylesheet" type="text/css" />
	</head>
...
<div class="mainbg" style="background:#7ABDE9;">
    <img src="${rootpath}/images/2.jpg" /><img src="${rootpath}/images/1.jpg" /><img src="${rootpath}/images/9.jpg" /><img src="${rootpath}/images/8.jpg" /><img src="${rootpath}/images/7.jpg" /></div>
	<ul class="mainmenu">

		<li>
				<a href="${rootpath}/index/sub/2377193369/532866745.html">
					<p><img src="${rootpath}/images/1.png" /><span>关于我们</span></p>
				</a>
			</li><li>
				<a href="${rootpath}/index/sub/2377193369/532866745.html" >
					<p><img src="${rootpath}/images/4.png" /><span>新闻中心</span></p>
				</a>
			</li><li>
				<a href="${rootpath}/index/sub/2377193369/532866745.html" >
					<p><img src="${rootpath}/images/13.png" /><span>产品展示</span></p>
				</a>
			</li><li>
				<a href="${rootpath}/index/sub/2377193369/532866745.html" >
					<p><img src="${rootpath}/images/20.png" /><span>成功案例</span></p>
				</a>
			</li><li>
				<a href="${rootpath}/index/sub/2377193369/532866745.html" >
					<p><img src="${rootpath}/images/5.png" /><span>下载中心</span></p>
				</a>
			</li><li>
				<a href="${rootpath}/index/sub/2377193369/532866745.html" >
					<p><img src="${rootpath}/images/14.png" /><span>人才招聘</span></p>
				</a>
			</li><li>
				<a href="${rootpath}/index/sub/2377193369/532866745.html" >
					<p><img src="${rootpath}/images/20.png" /><span>联系我们</span></p>
				</a>
			</li><li>
				<a href="${rootpath}/index/sub/2377193369/532866745.html" >
					<p><img src="${rootpath}/images/18.png" /><span>在线留言</span></p>
				</a>
			</li>	
...
.top_bar .top_menu>li.home a { height: 66px; width: 66px; margin: auto; border-radius: 60px; position: relative; top: -22px; left: 2px; background: url('${rootpath}/images/home.png') no-repeat center center; background-size: 100% 100%; }
...
<div class="top_bar" style="-webkit-transform:translate3d(0,0,0)">
  <nav>
    ...
    <li><a href="/"><img src="${rootpath}/images/plugmenu6.png"><label>首页</label></a>
                </li><li><a href="javascript:void(0)"><img src="${rootpath}/images/plugmenu5.png"><label>分享</label></a>
                </li>    
<li class="home"><a href="/"></a></li>
<li><a href="tel:13888888888"><img src="${rootpath}/images/plugmenu1.png"><label>拨号</label></a>
                </li><li><a href="javascript:void(0)"><img src="${rootpath}/images/plugmenu8.png"><label>短信</label></a>
                </li>    </ul>
  </nav>
</div>
